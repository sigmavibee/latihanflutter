...
Color borderColorRecentBooks = Color(0xFFF3F3F3);
Color blackColor = Color(0xFF2D2D2D);
Color blackColor2 = Color(0xFF000000);
Color greyColor = Color(0xFFBDBDBD);
Color searchColor = Color(0xFFF8F8F8);
Color greenColor = Color(0xFF098B5C);
Color recentColor = Color(0xFFAFAFAF);
Color greyinfoColor = Color(0xFFF7F7F7);
...
TextStyle regularText12 =
    GoogleFonts.poppins(fontSize: 12, fontWeight: regular, color: greyColor);
TextStyle mediumText14 = GoogleFonts.poppins(fontSize: 14, fontWeight: medium);
TextStyle mediumText12 =
    GoogleFonts.poppins(fontSize: 12, fontWeight: medium, color: dividerColor);
